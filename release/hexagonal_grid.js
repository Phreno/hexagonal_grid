System.register("grid/hex", [], function (exports_1, context_1) {
    "use strict";
    var Hex;
...
System.register("grid/double-offset-coord", ["grid/hex"], function (exports_2, context_2) {
    "use strict";
    var hex_1, DoubledCoord;
    ...
    return {
        ...
        execute: function () {
            DoubledCoord = class DoubledCoord {
                constructor(col, row) {
                    this.col = col;
                    this.row = row;
                }
            ...
            exports_2("DoubledCoord", DoubledCoord);
        }
    };
});
System.register("grid/orientation", [], function (exports_3, context_3) {
    "use strict";
    var Orientation;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_3("Orientation", Orientation);
        }
    };
});
System.register("grid/point", [], function (exports_4, context_4) {
    "use strict";
    var Point;
...
System.register("grid/layout", ["grid/orientation", "grid/point", "grid/hex"], function (exports_5, context_5) {
    "use strict";
    var orientation_1, point_1, hex_2, Layout;
...
System.register("grid/offset-coord", ["grid/hex"], function (exports_6, context_6) {
    "use strict";
    var hex_3, OffsetCoord;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_6("OffsetCoord", OffsetCoord);
            OffsetCoord.EVEN = 1;
            OffsetCoord.ODD = -1;
        }
    };
